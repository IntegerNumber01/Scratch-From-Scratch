...
public class ScratchError {
    public static void throwError(String text, int number, String errorMsg) {
        throwError(text, number, errorMsg, -1, -1); // call the main throwError method
    }

    public static void throwError(String text, int number, String errorMsg, int col) {
        throwError(text, number, errorMsg, col, -1); // call the main throwError method  
    }

    public static void throwError(String text, int number, String errorMsg, int col, int length) {
        System.out.println("Error on line " + number + ": " + errorMsg);
